...
{                                                                       \
		(x) = (MyZ80->Z_GetByte(address) & 0xff)                       \
				| ((MyZ80->Z_GetByte(address+1) & 0xff) << 8);         \
}
...
{                                                                       \
	MyZ80->Z_SetByte(address,x);                                        \
}

#define Z80_WRITE_WORD(address, x)                                      \
{                                                                       \
	  MyZ80->Z_SetByte(address & 0xffff,x & 0xff);                             \
	  MyZ80->Z_SetByte(address+1 & 0xffff,(x & 0xff00)>>8);                             \
}

//void  Z80_WRITE_WORD(int address, int x)
//{
//	  MyZ80->Z_SetByte(address & 0xffff,x & 0xff);
//	  MyZ80->Z_SetByte(address+1 & 0xffff,(x & 0xff00)>>8);
//}
